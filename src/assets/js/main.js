(function ($) {
  ...
  var swiper = new Swiper('.package-slider-2', {
    slidesPerView: 3,
    spaceBetween: 30,
    loop: true,
    navigation: {
  ...
  var swiper = new Swiper('.package-slider-3', {
    slidesPerView: 3,
    spaceBetween: 30,
    loop: true,
    navigation: {
  ...
  $('.first.circle')
    ...
    .on('circle-animation-progress', function (event, progress) {
      $(this)
        .find('strong')
        .html(Math.round(96 * progress) + '<span>%</span>');
    });
  ...
  $('.third.circle')
    ...
    .on('circle-animation-progress', function (event, progress) {
      $(this)
        .find('strong')
        .html(Math.round(70 * progress) + '<span>%</span>');
    });
